  ...
  return (
    <>
      <nav className="main-header navbar navbar-expand">
        ...
        <li className="nav-item">
            <Link to="/admin/add-task" title="Add new To-Do" className="nav-link" data-widget="fullscreen">
              <i className="fa fa-plus-circle mr-1"></i> Add To Do
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/admin/profile" title="My Profile" className="nav-link" data-widget="fullscreen">
